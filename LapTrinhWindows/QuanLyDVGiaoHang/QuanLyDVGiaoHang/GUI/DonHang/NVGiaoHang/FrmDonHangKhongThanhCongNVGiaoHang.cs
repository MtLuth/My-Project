...
{
    public partial class FrmDonHangKhongThanhCongNVGiaoHang : Form
    {
        private string TenDangNhap;
        public FrmDonHangKhongThanhCongNVGiaoHang(string tenDangNhap)
        {
            InitializeComponent();
        ...
        private void loadData()
        {
            using (var context = new QuanLyDVGiaoHangEntities())
            {
                List<DS_DONHANGCANGIAONHAN> donHangList = context.DS_DONHANGCANGIAONHAN
                    .Where(dh => dh.TKGiaoNhanHang == TenDangNhap && dh.GiaoNhan == true && dh.TrangThai == "Chưa hoàn thành")
                    .ToList();
        ...
        private void FrmDonHangKhongThanhCongNVGiaoHang_Load(object sender, EventArgs e)
        {
            loadData();
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            using (var context = new QuanLyDVGiaoHangEntities())
            {
                var result = context.DS_DONHANGCANGIAONHAN
                    .Where(dh => dh.TKGiaoNhanHang == TenDangNhap && dh.MaVanDon.ToString().Contains(giatri) && dh.GiaoNhan == true && dh.TrangThai == "Chưa hoàn thành")
                    .Select(dh => new
                    {
                        dh.MaDS,
                        dh.MaVanDon,
