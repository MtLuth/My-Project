...
{
    public partial class FrmDonHangThanhCongQLTT : Form
    {
        private string TenDangNhap;
        public FrmDonHangThanhCongQLTT(string tenDangNhap)
        {
            InitializeComponent();
        ...
        private void FrmDonHangThanhCongQLTT_Load(object sender, EventArgs e)
        {
            loadData();
        }
